  ...
  "WebSquare": {
    ...
    "projectCommon": {
      "module": [
        {
          "@name": "$c.common",
          "@src": "/cm/global_common_component/common.xml"
        },
        {
          "@name": "$c.str",
          "@src": "/cm/global_common_component/commonStr.xml"
        },
        {
          "@name": "$c.num",
          "@src": "/cm/global_common_component/commonNum.xml"
        },
        {
          "@name": "$c.menu",
          "@src": "/cm/global_common_component/commonMenu.xml"
        },
        {
          "@name": "$c.code",
          "@src": "/cm/global_common_component/commonCode.xml"
        },
        {
          "@name": "$c.popup",
          "@src": "/cm/global_common_component/commonPopup.xml"
        },
        {
          "@name": "$c.util",
          "@src": "/cm/global_common_component/commonUtil.xml"
        }
      ]
    },
    "xhr": {
